...
/*
 * Reverse a string with pointer in r0 and length in r1.
 */
.globl ReverseString
ReverseString:
    start .req r0
...
/*
 * Converts unsigned word in r0 and stores it to the address in r1 and returns
 * the length of the string in r0. If r1 is 0, the string is not output.
 * The output string is not longer than 32 characters, base of the number is
 * given in r2. Base can be [2,36]
 */
...
/**
 * Converts signed word in r0 and stores it to the address in r1 and returns the
 * length of the string in r0. If r1 is 0, doesn't output the string. The output
 * string is not longer than 32 characters. The base of the number is given in
 * r2 and can be [2,36]
 * 
 */
.globl SignedString
